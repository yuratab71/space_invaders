...
{
    audio->main_theme = LoadMusicStream("./music/10-theme-main-101soundboards.mp3");
    audio->explosion_1 = LoadSound("./music/spaceship/mp3/explosion/explosion1.mp3");
    audio->explosion_2 = LoadSound("./music/spaceship/mp3/explosion/explosion8.mp3");
    audio->explosion_3 = LoadSound("./music/spaceship/mp3/explosion/explosion11.mp3");
    return;
    audio->player_gun = LoadSound("./music/spaceship/mp3/laser/laser_shoot7.mp3");
