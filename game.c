...
{
    player->idle = LoadTexture("./assets/PixelSpaceRage/128px/PlayerBlue_Frame_01_png_processed.png");
    player->right_1 = LoadTexture("./assets/PixelSpaceRage/128px/"
                                  "PlayerBlue_Frame_02_png_processed_flipped.png");
    player->right_2 = LoadTexture("./assets/PixelSpaceRage/128px/"
                                  "PlayerBlue_Frame_03_png_processed_flipped.png");
    player->left_1 = LoadTexture("./assets/PixelSpaceRage/128px/PlayerBlue_Frame_02_png_processed.png");
    player->left_2 = LoadTexture("./assets/PixelSpaceRage/128px/PlayerBlue_Frame_03_png_processed.png");
    player->projectile = LoadTexture("./assets/PixelSpaceRage/128px/Proton_Large_png_processed.png");
    return;
};

void GameLoadEnemyTextures(EnemyTextures *textures)
{
    textures->red = LoadTexture("./assets/PixelSpaceRage/128px/Enemy01_Red_Frame_2_png_processed.png");
    textures->green = LoadTexture("./assets/PixelSpaceRage/128px/Enemy01_Green_Frame_1_png_processed.png");
    textures->teal = LoadTexture("./assets/PixelSpaceRage/128px/Enemy01_Teal_Frame_1_png_processed.png");
    textures->red_small = LoadTexture("./assets/PixelSpaceRage/128px/Enemy02Red_Frame_1_png_processed.png");
    textures->projectile = LoadTexture("./assets/PixelSpaceRage/128px/Plasma_Large_png_processed.png");
    return;
};
...
void GameInitEnemies(EnemiesSettings *settings, int enemy_x_length, int enemy_y_len,
                     Enemy enemies[enemy_x_length][enemy_y_len], Enemy *wenemy, Projectile *projectile,
                     float start_pos_x)
{
    ...
    projectile->pos = GameGetRandomEnemyPosition(enemy_x_length, enemy_y_len, enemies);
...
void GameProcessEnemyGridMovement(EnemiesSettings *settings, int enemy_x_length, int enemy_y_length,
                                  Enemy enemies[enemy_x_length][enemy_y_length])
{
    if (settings->move_timer < 1.0f)
    {
        if (settings->move_counter == 0 && (settings->move_dir == LEFT || settings->move_dir == RIGHT))
        {
...
Vector2 GameGetRandomEnemyPosition(int enemy_x_length, int enemy_y_length,
                                   Enemy enemies[enemy_x_length][enemy_y_length])
{
...
void GameDrawPlayer(PlayerSettings *player)
{
    ...
    if (player->acceleration < -70.0f)
    {
        DrawTexture(player->left_2, player->collider.x - 15.0f, player->collider.y, WHITE);
        return;
    };
    if (player->acceleration < -30.0f)
    {
        DrawTexture(player->left_1, player->collider.x - 15.0f, player->collider.y, WHITE);
        return;
    };
...
void GameDrawEnemies(int enemy_x_axis, int enemy_y_axis, Enemy enemies[enemy_x_axis][enemy_y_axis], Texture2D *texture)
{
    for (int i = 0; i < enemy_x_axis; i++)
    {
        for (int j = 0; j < enemy_y_axis; j++)
        {
            if (enemies[i][j].is_alive)
            {
                DrawTextureEx(*texture, (Vector2){enemies[i][j].pos.x, enemies[i][j].pos.y}, 0.0f, 1.0f, WHITE);
            };
        };
    };
};
...
{
    textures->exp_1 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_01_png_processed.png");
    textures->exp_2 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_02_png_processed.png");
    textures->exp_3 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_03_png_processed.png");
    textures->exp_4 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_04_png_processed.png");
    textures->exp_5 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_05_png_processed.png");
    textures->exp_6 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_06_png_processed.png");
    textures->exp_7 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_07_png_processed.png");
    textures->exp_8 = LoadTexture("./assets/PixelSpaceRage/128px/Explosion01_Frame_08_png_processed.png");
};
